...
Creates BIP84 keychains for Tron

## Installing

Run - `npm install tron-bip84 --save`

## Using

```javascript
const { fromMnemonic, fromZPrv, fromZPub } = require('tron-bip84')
...
console.log("Account 0, first receiving address = m/84'/195'/0'/0/1");
...
console.log("Account 0, first receiving address = m/84'/195'/0'/0/2");
...
console.log("Account 1, root = m/84'/195'/0'");
console.log('Account 1 zpub:', account1.getAccountPublicKey());
console.log('\n');

console.log("Account 1, first receiving address = m/84'/195'/0'/0/0");
